...
import com.lavreniuk.campassistant.pupil.CreateContactDialog.Companion.NAME_INTENT_PARAM
import com.lavreniuk.campassistant.pupil.CreateContactDialog.Companion.VALUE_INTENT_PARAM
...
class CreateContactDialog : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        create_contact_dialog_contact_name_input.postDelayed(
            ShowKeyboard(create_contact_dialog_contact_name_input, this),
            HALF_SECOND_DELAY
        )
